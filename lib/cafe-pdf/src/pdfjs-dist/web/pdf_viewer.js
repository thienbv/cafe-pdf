...
function () {
  function PDFPageView(options) {
    ...
    div.className = 'page';
    var divId = options.prefixRenderId ? options.prefixRenderId+this.id : this.renderingId
...
function () {
  function BaseViewer(options) {
    ...
    this.prefixRenderId = options.prefixRenderId;
      ...
      firstPagePromise.then(function (pdfPage) {
        ...
        for (var pageNum = 1; pageNum <= pagesCount; ++pageNum) {
          ...
          var pageView = new _pdf_page_view.PDFPageView({
            ...
            prefixRenderId: _this2.prefixRenderId
,
